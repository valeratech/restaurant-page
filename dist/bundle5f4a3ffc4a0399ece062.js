...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "* {\n  box-sizing: border-box;\n  margin: 0;\n  padding: 0;\n}\n\nbody {\n  display: grid;\n  grid-template-rows: 1fr 6fr 0.5fr;\n  font-family: \"Mitr\", sans-serif;\n  background-color: #EEF327;\n}\n\nheader {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  background-color: #ffffff;\n}\n\nnav {\n  display: flex;\n  justify-content: space-between;\n  width: 80%;\n}\n\nul {\n  list-style: none;\n  align-self: end;\n  padding-bottom: 15px;\n}\n\nli {\n  margin-left: 50px;\n  font: 1.563rem bolder;\n  font-family: \"Mitr\", sans-serif;\n  color: inherit;\n  text-decoration: underline 3px rgba(109, 178, 63, 0);\n  transition: text-decoration-color 300ms;\n}\n\nli:hover {\n  color: #6DB23F;\n  text-decoration-color: rgb(109, 178, 63);\n  cursor: pointer;\n}\n\n.home {\n  display: flex;\n  align-items: center;\n  background: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ") no-repeat center center fixed;\n  background-size: cover;\n  height: 90vh;\n}\n\n.info-box {\n  margin-left: 300px;\n  background-color: #000000;\n  color: #ffffff;\n  opacity: 0.85;\n  padding: 30px 40px;\n  max-width: 700px;\n}\n\n.info-box > p {\n  font-size: 1.25rem;\n}\n\n.menu {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  flex-direction: column;\n}\n\n.menu-box {\n  max-width: 1500px;\n  display: grid;\n  grid-template-columns: repeat(auto-fill, minmax(350px, 1fr));\n  grid-gap: 35px;\n  padding: 50px 0 100px;\n}\n\n.menu-tiles {\n  /*display: flex;*/\n  /*flex-direction: column;*/\n}\n\n.menu-img {\n  border: solid 1px #cecece;\n  border-bottom: none;\n  border-top-right-radius: 25px;\n  border-top-left-radius: 25px;\n}\n\n.menu-text {\n  border: solid 1px #cecece;\n  border-bottom-left-radius: 25px;\n  border-bottom-right-radius: 25px;\n  border-top: none;\n  padding: 15px;\n}\n\nimg {\n  max-width: 100%;\n  max-height: 100%;\n  object-fit: contain;\n  border-radius: 25px;\n}\n\n.menu > h2, .menu > p {\n  /*align-self: baseline;*/\n}\n\nh1 {\n  color: #6DB23F;\n  font-size: 3.052rem;\n}\n\nh2 {\n  font-size: 3.815rem;\n}\n\nmain {\n  background-color: #ffffff;\n}\n\n.contact {\n  display: flex;\n  justify-content: center;\n  flex-direction: column;\n  align-items: center;\n  background-color: #000000;\n}\n\n.contact > h2 {\n  color: #ffffff;\n}\n\n.contact-info {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  flex-direction: column;\n  background-color: #ffffff;\n  height: 850px;\n  width: 70%;\n}\n\nfooter {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  background-color: #EEF327;\n  border-top-left-radius: 50px;\n  border-top-right-radius: 50px;\n  position: relative;\n  bottom: 40px;\n}\n\n.tab-list {\n  display: flex;\n}", "",{"version":3,"sources":["webpack://./src/styles/main.css"],"names":[],"mappings":"AACA;EACI,sBAAA;EACA,SAAA;EACA,UAAA;AACJ;;AAEA;EACI,aAAA;EACA,iCAAA;EACA,+BAAA;EACA,yBAAA;AACJ;;AAGA;EACI,aAAA;EACA,uBAAA;EACA,mBAAA;EACA,yBAAA;AAAJ;;AAGA;EACI,aAAA;EACA,8BAAA;EACA,UAAA;AAAJ;;AAIA;EACI,gBAAA;EACA,eAAA;EACA,oBAAA;AADJ;;AAIA;EACI,iBAAA;EACA,qBAAA;EACA,+BAAA;EACA,cAAA;EACA,oDAAA;EACA,uCAAA;AADJ;;AAIA;EACI,cAAA;EACA,wCAAA;EACA,eAAA;AADJ;;AAIA;EACI,aAAA;EACA,mBAAA;EACA,iFAAA;EACA,sBAAA;EACA,YAAA;AADJ;;AAIA;EACI,kBAAA;EACA,yBAAA;EACA,cAAA;EACA,aAAA;EACA,kBAAA;EACA,gBAAA;AADJ;;AAIA;EACI,kBAAA;AADJ;;AAIA;EACI,aAAA;EACA,uBAAA;EACA,mBAAA;EACA,sBAAA;AADJ;;AAIA;EACI,iBAAA;EACA,aAAA;EACA,4DAAA;EACA,cAAA;EACA,qBAAA;AADJ;;AAIA;EACI,iBAAA;EACA,0BAAA;AADJ;;AAIA;EACI,yBAAA;EACA,mBAAA;EACA,6BAAA;EACA,4BAAA;AADJ;;AAIA;EACI,yBAAA;EACA,+BAAA;EACA,gCAAA;EACA,gBAAA;EACA,aAAA;AADJ;;AAIA;EACI,eAAA;EACA,gBAAA;EACA,mBAAA;EACA,mBAAA;AADJ;;AAIA;EACI,wBAAA;AADJ;;AAKA;EACI,cAAA;EACA,mBAAA;AAFJ;;AAKA;EACI,mBAAA;AAFJ;;AAKA;EACI,yBAAA;AAFJ;;AAKA;EACI,aAAA;EACA,uBAAA;EACA,sBAAA;EACA,mBAAA;EACA,yBAAA;AAFJ;;AAKA;EACI,cAAA;AAFJ;;AAKA;EACI,aAAA;EACA,uBAAA;EACA,mBAAA;EACA,sBAAA;EACA,yBAAA;EACA,aAAA;EACA,UAAA;AAFJ;;AAKA;EACI,aAAA;EACA,uBAAA;EACA,mBAAA;EACA,yBAAA;EACA,4BAAA;EACA,6BAAA;EACA,kBAAA;EACA,YAAA;AAFJ;;AAKA;EACI,aAAA;AAFJ","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Mitr&display=swap');\n* {\n    box-sizing: border-box;\n    margin: 0;\n    padding: 0;\n}\n\nbody {\n    display: grid;\n    grid-template-rows: 1fr 6fr .5fr;\n    font-family: 'Mitr', sans-serif;\n    background-color: #EEF327;\n\n}\n\nheader {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    background-color: #ffffff;\n}\n\nnav {\n    display: flex;\n    justify-content: space-between;\n    width: 80%;\n\n}\n\nul {\n    list-style: none;\n    align-self: end;\n    padding-bottom: 15px;\n}\n\nli {\n    margin-left: 50px;\n    font: 1.563rem bolder;\n    font-family: 'Mitr', sans-serif;\n    color: inherit;\n    text-decoration: underline 3px rgba(109, 178, 63, 0);\n    transition: text-decoration-color 300ms;\n}\n\nli:hover {\n    color: #6DB23F;\n    text-decoration-color: rgba(109, 178, 63, 1);\n    cursor: pointer;\n}\n\n.home {\n    display: flex;\n    align-items: center;\n    background: url(\"../assets/chicken-nuggets.jpg\") no-repeat center center fixed;\n    background-size: cover;\n    height: 90vh;\n}\n\n.info-box {\n    margin-left: 300px;\n    background-color: #000000;\n    color: #ffffff;\n    opacity: .85;\n    padding: 30px 40px;\n    max-width: 700px;\n}\n\n.info-box > p {\n    font-size: 1.25rem;\n}\n\n.menu {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    flex-direction: column;\n}\n\n.menu-box {\n    max-width: 1500px;\n    display: grid;\n    grid-template-columns: repeat(auto-fill, minmax(350px, 1fr));\n    grid-gap: 35px;\n    padding: 50px 0 100px ;\n}\n\n.menu-tiles {\n    /*display: flex;*/\n    /*flex-direction: column;*/\n}\n\n.menu-img {\n    border: solid 1px #cecece;\n    border-bottom: none;\n    border-top-right-radius: 25px;\n    border-top-left-radius: 25px;\n}\n\n.menu-text {\n    border: solid 1px #cecece;\n    border-bottom-left-radius: 25px;\n    border-bottom-right-radius: 25px;\n    border-top: none;\n    padding: 15px;\n}\n\nimg {\n    max-width: 100%;\n    max-height: 100%;\n    object-fit: contain;\n    border-radius: 25px;\n}\n\n.menu > h2, .menu > p {\n    /*align-self: baseline;*/\n\n}\n\nh1 {\n    color: #6DB23F;\n    font-size: 3.052rem\n}\n\nh2 {\n    font-size: 3.815rem;\n}\n\nmain {\n    background-color: #ffffff\n}\n\n.contact {\n    display: flex;\n    justify-content: center;\n    flex-direction: column;\n    align-items: center;\n    background-color: #000000;\n}\n\n.contact > h2 {\n    color: #ffffff;\n}\n\n.contact-info {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    flex-direction: column;\n    background-color: #ffffff;\n    height: 850px;\n    width: 70%\n}\n\nfooter {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    background-color: #EEF327;\n    border-top-left-radius: 50px;\n    border-top-right-radius: 50px;\n    position: relative;\n    bottom: 40px;\n}\n\n.tab-list {\n    display: flex\n}\n\n"],"sourceRoot":""}]);
// Exports
...
/******/ })()
;
//# sourceMappingURL=bundle5f4a3ffc4a0399ece062.js.map